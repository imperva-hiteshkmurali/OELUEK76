...
#define __NR_syscall_max 473 /* sizeof(syscalls_64) - 1 */
#define NR_syscalls 474 /* sizeof(syscalls_64) */
#define __NR_syscall_compat_max 473 /* sizeof(syscalls_ia32) - 1 */
#define IA32_NR_syscalls 474 /* sizeof(syscalls_ia32) */

#define TASK_threadsp 5080 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2288 /* offsetof(struct task_struct, stack_canary) */

#define TASK_addr_limit 5208 /* offsetof(struct task_struct, thread.addr_limit) */
...
#define VMX_spec_ctrl 15976 /* offsetof(struct vcpu_vmx, spec_ctrl) */
